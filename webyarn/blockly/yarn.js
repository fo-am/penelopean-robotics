 ...
 */
Blockly.Yarn.ORDER_ATOMIC = 0;          // literals
// The next level was not explicit in documentation and inferred by Ellen.
Blockly.Yarn.ORDER_HIGH = 1;            // Function calls, tables[]
Blockly.Yarn.ORDER_EXPONENTIATION = 2;  // ^
Blockly.Yarn.ORDER_UNARY = 3;           // not # - ~
Blockly.Yarn.ORDER_MULTIPLICATIVE = 4;  // * / %
Blockly.Yarn.ORDER_ADDITIVE = 5;        // + -
Blockly.Yarn.ORDER_CONCATENATION = 6;   // ..
Blockly.Yarn.ORDER_RELATIONAL = 7;      // < > <=  >= ~= ==
Blockly.Yarn.ORDER_AND = 8;             // and
Blockly.Yarn.ORDER_OR = 9;              // or
Blockly.Yarn.ORDER_NONE = 99;

/**
 * Note: Yarn is not supporting zero-indexing since the language itself is
 ...
 * anything. In Yarn, an expression is not a legal statement, so we must assign
...
/**
 * Encode a string as a properly escaped multiline Yarn string, complete with
 * quotes.
 * @param {string} string Text to encode.
 * @return {string} Yarn string.
 * @private
