...
// disabled servos
// added temp sensor
// added sleep register
// disabled ee read on startup

// v2
// added direct i2c interface
// reuse PC0,1,2 as ADC 0,1,2 (plug in to old servo ports!)
// added VCC internal voltage
// reenabled ee read

#define ROBOT_ID 0x99 // also change the id below!
#define RADIO_ID 0xA7A7A7A799
